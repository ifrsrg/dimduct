...
from dim.arbitraria import Ui_Arbitraria
from dim.constante1 import Ui_Constante1
from dim.constante2 import Ui_Constante2
from dim.estatica import Ui_Estatica
...
"QPushButton { border-radius: 5px; background-color: white; border-bottom: 1px solid black; font-size: 15px }\n"
"QPushButton:hover { border-top: 1px solid black }")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.button_arbitrario.setText(_translate("MainWindow", "Velocidade Arbitrária"))
        self.button_constante1.setText(_translate("MainWindow", "Perda de Carga Constante ASHRAE"))
        self.button_constante2.setText(_translate("MainWindow", "Perda de Carga Constante Clássico"))
        self.button_estatica.setText(_translate("MainWindow", "Recuperação da Pressão Estática"))
        self.button_info.setText(_translate("MainWindow", "Informações (PDF)"))
        self.button_exit.setText(_translate("MainWindow", "Sair"))
        self.versao.setText(_translate("MainWindow", "v. 09-18"))
    ...
    def on_arbitraria_clicked(self):
        ...
        # caminho relativo ao DIMduct.py
