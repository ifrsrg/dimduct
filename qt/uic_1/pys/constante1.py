...
"QLabel { color: white }")
    ...
    def calcula(self):
        ...
        results["D_1"] = str(math.floor(D_1 * 1000)/1000) + "m"
        results["u_1"] = str(math.floor(u_1 * 1000)/1000) + "m/s"
        results["A_1"] = str(math.floor(A_1 * 1000)/1000) + "m²"
        results["D_2"] = str(math.floor(D_2 * 1000)/1000) + "m"
        results["u_2"] = str(math.floor(u_2 * 1000)/1000) + "m/s" 
        results["A_2"] = str(math.floor(A_2 * 1000)/1000) + "m²"
        results["dP_m"] = str(math.floor(dP_m * 1000)/1000) + "Pa/m"
