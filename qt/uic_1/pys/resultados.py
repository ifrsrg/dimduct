...
class Ui_Resultados(object):
    def setupUi(self, Resultados, **kwds):
...
"QLineEdit{ background-color: white; color: black }")
        ...
        for key in kwds:
	        ...
	        self.labelsright[label_index].setText(_translate("Resultados", kwds[key]))
    ...
    def retranslateUi(self, Resultados):
        _translate = QtCore.QCoreApplication.translate
        Resultados.setWindowTitle(_translate("Resultados", "Form"))
